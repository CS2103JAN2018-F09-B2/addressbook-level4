...
==== Why?
This feature, in addition to the searching feature, removes the need for manual copy-pasting when the user adds a recipe. This single command can replace the long and repetitive process of moving mouse, selecting text, copying and pasting.
