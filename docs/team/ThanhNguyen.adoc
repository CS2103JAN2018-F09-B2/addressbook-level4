...
* https://github.com/CS2103JAN2018-F09-B2/main/blob/master/collated/functional/kokonguyen191.md[Functional code]
* https://github.com/CS2103JAN2018-F09-B2/main/blob/master/collated/test/kokonguyen191.md[Test code]
...
==== Why?
Pictures of food usually are very bright and thus look bad on dark background. Therefore, a bright theme will provide better user experience.
...
=== New feature: Searching for recipe on the Internet
==== Why?
...
==== Why?
This feature, in addition to the searching feature, removes the need for manual copy-pasting when the user adds a recipe. This single command can replace a long process of moving mouse, selecting text, copying and pasting.
...
=== New feature: Downloading an image if a URL is passed to an `add` or `edit` command
==== Why?
